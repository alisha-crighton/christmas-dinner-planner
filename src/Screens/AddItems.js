...
function AddItems() {
    ...
    fetch(`https://christmas-dinner-planner.onrender.com/add_item/${username}`, {
        method: 'POST',
    ...
    const handleCancelItem = () => {
        ...
        else { navigate (`/${username}/AllItems`)}
    }

  return (
    <div className="homepage" >
        <div className = "button-row">
        <Link  to={`/${username}/AllItems`} style={{color:'#4d0d19', borderColor: 'white', marginTop:40, marginLeft:15, textDecoration: "none", display: 'flex', alignItems: 'center', fontFamily: 'Handlee', fontSize:"18px", justifyContent:'flex-start', width:'100%' }}>
